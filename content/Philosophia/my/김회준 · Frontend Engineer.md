...
안녕하세요. 르몽의 설명을 보고 제가 예전부터 정말 필요하다고 느끼는, 그리고 실제로 많은 자영업자들에게 임팩트 있게 도움이 될만한 아이템이라고 생각되어 합류하고 싶은데요! 안타깝게도 RN에 대한 경험이 없어 자격 요건을 갖추지 못했어요. 그럼에도 저에게 관심이 있으시거나, 혹은 적합한 자리가 난다면 연락 부탁드립니다!`(_ _)`
...
그동안의 경험을 통해 실용주의적 프로그래밍을 지향하게 되었고, [Ash Framework의 Resource-oriented, Declarative Design](https://hexdocs.pm/ash/design-principles.html)에 깊이 공감합니다. 최근에는 이 방식이 **사람뿐 아니라 에이전트가 다루기에도 매우 효율적**이라는 점을 실감하고 있습니다.
...
- **리소스-명시적 실천.** IaC, GitOps, FSM, Schema 그리고 **SOPS**로 비밀을, **Mise**로 팀 개발 환경을 선언적으로 관리합니다.
