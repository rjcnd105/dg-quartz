...
팀원들과 같이 프로덕트를 만들어 나갈때 재미있고, 열정이 샘솟습니다.
저는 프로덕트의 의사결정에 적극적으로 참여합니다.
...
- 젠틀몬스터 렌더링 최적화 및 인증·보안 이슈 처리·가이드
- 매쓰플랫 2 프론트엔드 모노레포 구조 설계, 공용 컴포넌트, 코어 비즈니스 로직 작성
