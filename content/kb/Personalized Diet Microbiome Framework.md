...
Personalized diet microbiome framework는 단일 "좋은 음식"보다 개인의 반복 식품과 변동 식품이 gut microbiome을 어떻게 흔드는지 추적하려는 접근이다.

## 핵심 내용

University of Minnesota 보도에 따르면, Gut Microbes Reports 논문은 개인 식단을 core foods와 secondary foods로 나눠 gut microbiome 연구에 적용하는 방법을 제안한다 (출처: [[Analyzing individual food patterns for healthier gut microbiomes]]). Core foods는 일상적으로 반복되는 식단의 기반이고, secondary foods는 자주 바뀌는 식품이다.
