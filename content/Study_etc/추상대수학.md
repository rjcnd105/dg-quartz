---
publish: true
created: 2024-02-07T08:30:58Z
modified: 2025-11-19T02:23:56Z
tags:
  - 현대대수학
  - 추상대수학
  - Category-theory
...
- 참고자료
  ...
  [alice\_college\_math\_lecture.pdf](alice_college_math_lecture.pdf)

## 카테고리 이론 (범주론, _[Category theory](https://ncatlab.org/nlab/show/category+theory))_
...
군은 \*_\<G, _>__  일때 다음 공리들을 만족하는 연산 \*를 가진 집합 G를 말한다.

1. \*는 결합적
2. G의 모든 원소 a에 대해 &#x61;_&#x65;=a 이고 &#x65;_&#x61;=a인 원소 e가 G에 존재한다.
3. G의 모든 원소 a에 대해
...
![500](env/첨부파일/math5.png)

![600](env/첨부파일/math6.png)

![800](env/첨부파일/math7.png)

예)

![600](env/첨부파일/math8.png)

### **역원 (inverse element)**

집합 S와 이항연산자 \*에 대해, 만약 [항등원](영구-진행/추상대수학/추상대수학.md) e가 존재한다고 할 때

S의 원소 a에 대해 &#x61;_&#x62; = &#x62;_&#x61; = e를 만족하는 S의 원소 b가 유일하게 존재할 때

b를 a의 역원이라고 한다.

모든 군에서 각 원소의 역원은 단 하나만 존재할 수 있다.

![400](env/첨부파일/math9.png)
